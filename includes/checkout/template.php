...
function edd_user_info_fields() {
	...
	<fieldset id="edd_checkout_user_info">
		<legend><?php echo apply_filters( 'edd_checkout_personal_info_text', esc_html( 'Personal Info', 'easy-digital-downloads' ) ); ?></legend>
		<?php do_action( 'edd_purchase_form_beforeesc_html_email' ); ?>
		<p id="edd-email-wrap">
			<label class="edd-label" for="edd-email">
				<?php esc_html_e( 'Email Address', 'easy-digital-downloads' ); ?>
				<?php if( edd_field_is_required( 'eddesc_html_email' ) ) { ?>
			...
			<input class="edd-input required" type="email" name="eddesc_html_email" placeholder="<?php esc_html_e( 'Email address', 'easy-digital-downloads' ); ?>" id="edd-email" value="<?php echo esc_attr( $customer['email'] ); ?>" aria-describedby="edd-email-description" />
		</p>
		<?php do_action( 'edd_purchase_form_afteresc_html_email' ); ?>
		...
		<p id="edd-last-name-wrap">
			...
			<span class="edd-description" aria-describedby="edd-last-description"><?php esc_html_e( 'We will use this as well to personalize your account experience.', 'easy-digital-downloads' ); ?></span>
